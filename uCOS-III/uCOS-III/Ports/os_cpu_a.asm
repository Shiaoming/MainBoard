...
OSStartHighRdy
    ...
    LDMFD    SP!, {R3-R11}                                      ; Restore r4-11 from new process stack
	
	MOV		 LR,   R3;取EXC_RETURN
#ifdef __ARMVFP__	
	TST		LR,	 #0x10;判断是否浮点
	IT		EQ
	VLDMIAEQ  SP!, {S16-S31};如果是浮点,恢复S16-S31
#endif	
...
#endif
	MOV		R3,	 LR
	STMFD   R0!, {R3-R11};保存EXC_RETURN和R4-R11                            ; Save remaining regs r4-11 on process stack
...
OS_CPU_PendSVHandler_nosave
    ...
    LDMFD   R0!, {R3-R11};恢复R4-R11和EXC_RETURN                            ; Restore r4-11 from new process stack
	MOV		LR,	 R3
#ifdef __ARMVFP__
	;LDMFD	R0!, {S16-S31};恢复S16-S31
	TST		LR,	 #0x10
	IT		EQ
